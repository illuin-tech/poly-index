...
import static tech.illuin.indexed.operator.map.MapCombinationIndexTest.Indexable.*;
import static tech.illuin.indexed.operator.map.MapCombinationKey.excludes;
import static tech.illuin.indexed.operator.map.MapCombinationKey.requires;
